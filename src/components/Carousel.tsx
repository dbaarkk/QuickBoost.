...
import { Shield, Zap, Users, Star, Clock } from 'lucide-react';
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden p-4 ${
        round ? 'rounded-full border border-white' : 'rounded-[24px] border border-[#2A2A2A]'
      }`}
      style={{
        width: `${baseWidth}px`,
          ...
          return (
            <motion.div
              ...
              className={`relative shrink-0 flex flex-col ${
                round
                  ? 'items-center justify-center text-center bg-[#1E1E1E] border-0'
                  : 'items-start justify-between bg-[#2A2A2A] border border-[#2A2A2A] rounded-[12px]'
            ...
            >
              <div className={`${round ? 'p-0 m-0' : 'mb-4 p-5'}`}>
                <span className="flex h-[28px] w-[28px] items-center justify-center rounded-full bg-[#00CFFF]/20">
                  {item.icon}
                </span>
              </div>
              <div className="p-5">
                <div className="mb-1 font-black text-lg text-[#E0E0E0]">{item.title}</div>
