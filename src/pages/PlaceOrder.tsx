...
const servicesData = [
  ...
  { id: 7, name: 'Instagram Auto Likes', platform: 'Instagram', category: 'Likes', price: 15.00, min_order: 100, max_order: 100000, description: 'Automatic likes for your future Instagram posts', delivery_time: 'Instant', rating: 4.5, is_active: true },
  ...
  { id: 9, name: 'Instagram Shares', platform: 'Instagram', category: 'Shares', price: 25.00, min_order: 25, max_order: 100000, description: 'Instagram post shares to stories from real users', delivery_time: '0-3 hours', rating: 4.3, is_active: true },
  ...
  { id: 14, name: 'YouTube Comments', platform: 'YouTube', category: 'Comments', price: 100.00, min_order: 500, max_order: 50000, description: 'Custom YouTube comments from real users', delivery_time: '2-12 hours', rating: 4.4, is_active: true },
  ...
  { id: 27, name: 'Twitter Retweets', platform: 'Twitter', category: 'Retweets', price: 35.00, min_order: 250, max_order: 50000, description: 'Twitter retweets from real active accounts', delivery_time: '0-2 hours', rating: 4.3, is_active: true },
  { id: 28, name: 'Twitter Comments', platform: 'Twitter', category: 'Comments', price: 80.00, min_order: 100, max_order: 50000, description: 'Custom Twitter replies from real users', delivery_time: '1-6 hours', rating: 4.2, is_active: true },
  ...
  { id: 37, name: 'LinkedIn Connections', platform: 'LinkedIn', category: 'Connections', price: 100.00, min_order: 10, max_order: 200000, description: 'LinkedIn connection requests from real professionals', delivery_time: '6-24 hours', rating: 4.2, is_active: true },
  ...
  { id: 40, name: 'LinkedIn Shares', platform: 'LinkedIn', category: 'Shares', price: 60.00, min_order: 10, max_order: 10000, description: 'LinkedIn post shares from professional users', delivery_time: '1-6 hours', rating: 4.2, is_active: true },
